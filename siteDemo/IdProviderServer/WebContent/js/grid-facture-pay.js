...
Ext.onReady(function(){
	...
	var colFacture = new Ext.grid.ColumnModel([
            {header: "Organisme", sortable: true, renderer: organisme, width : 80, dataIndex:'organisme'},
			{header: "Montant", width: 60, sortable: true, renderer: montant, dataIndex: 'montantFacture'},
			...
			{header: "Num&eacute;ro d'ordre<br/>de Paiement", width: 90, sortable: true, dataIndex: 'ordre'},
...
// On ajoute les tooltips
	function setToolTip(item,index,all)
	{
		...
		new Ext.ToolTip({
			...
			html: 'Acc&eacute;der &agrave; mon espace en ligne <br/>s&eacute;curis&eacute; ' + organisme.name+'<br/><img src="'+organisme.logo+'"/>',
			trackMouse:true
			});
	}
