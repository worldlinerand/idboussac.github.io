...
if(Ext.DatePicker){
   Ext.apply(Ext.DatePicker.prototype, {
      todayText         : "Hoje",
      minText           : "Esta data &eacute; anterior at  menor data",
      maxText           : "Esta data &eacute; posterior at  maior data",
      disabledDaysText  : "",
      disabledDatesText : "",
...
if(Ext.PagingToolbar){
   Ext.apply(Ext.PagingToolbar.prototype, {
      ...
      displayMsg     : "<b>{0} at  {1} de {2} registo(s)</b>",
...
if(Ext.form.HtmlEditor){
   Ext.apply(Ext.form.HtmlEditor.prototype, {
	 ...
	 buttonTips : {
           ...
           justifyleft : {
               title: 'Alinhar at  Esquerda',
               text: 'Alinha o texto at  esquerda.',
               cls: 'x-html-editor-tip'
           },
           justifycenter : {
               title: 'Centrar Texto',
           ...
           justifyright : {
               title: 'Alinhar at  Direita',
               text: 'Alinha o texto at  direita.',
               cls: 'x-html-editor-tip'
           },
           insertunorderedlist : {
