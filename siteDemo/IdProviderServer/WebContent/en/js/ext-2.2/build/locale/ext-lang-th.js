...
Ext.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">Â¡ÃÃÃÂ§Ã¢ÃÃÅ½...</div>';
...
if(Ext.grid.GridPanel){
  Ext.grid.GridPanel.prototype.ddText = "{0} Ã ÃÃÃÂ¡Ã¡ÃÃ©ÃÂ·ÃÃ©Â§ÃÃÅ½Ã¡Â¶Ã";
}
...
if(Ext.form.Field){
  Ext.form.Field.prototype.invalidText = "â¬Ã¨ÃÂ¢ÃÂ§ÂªÃ¨ÃÂ§Â¹ÃÃ©Ã¤ÃÃ¨Â¶ÃÂ¡ÂµÃ©ÃÂ§";
}
...
if(Ext.PagingToolbar){
  Ext.apply(Ext.PagingToolbar.prototype, {
    ...
    afterPageText  : "of {0}",
    firstText      : "ÃÂ¹Ã©ÃÃ¡ÃÂ¡",
    prevText       : "Â¡Ã¨ÃÂ¹ÃÂ¹Ã©Ã",
    nextText       : "Â¶ÃÅ½Ã¤Â»",
    lastText       : "ÃÂ¹Ã©ÃÃÃÅ½Â·Ã©ÃÃ",
    refreshText    : "ÃÃÃ Â¿ÃÂª",
    displayMsg     : "Â¡ÃÃÃÂ§Ã¡ÃÅ½Â§ {0} - {1} Å¡ÃÂ¡ {2}",
    emptyMsg       : 'Ã¤ÃÃ¨ÃÃÂ¢Ã©ÃÃÃÃÃ¡ÃÅ½Â§'
  });
}
