...
//fonction permettant de mettre la petite fleche a cot̩  des titres vers le bas quand le menu est actif
...
function setMain()
{
	...
	setMap("");
	// Mise a z̩ro des champs s̩lectionn̩s sur le c̫t̩
}
//---------------------------fin header--------------------------------------
//--------------------------sur toutes les pages---------------------------
// RECEIVEDPERATION DE LA DATE
var now = new Date();
var jour=now.getDay();
...
if (month==1)
{
nowtoday += jour+", "+"January"+" "+numday+" "+numyear;
}
if (month==2)
{
nowtoday += jour+" "+numday+" "+"F̩vrier"+" "+numyear;
}
if (month==3)
{
nowtoday += jour+", "+"March"+" "+numday+" "+numyear;
}
if (month==4)
{
nowtoday += jour+", "+"April"+" "+numday+" "+numyear;
}
if (month==5)
{
nowtoday += jour+", "+"May"+" "+numday+" "+numyear;
}
if (month==6)
{
nowtoday += jour+", "+"June"+" "+numday+" "+numyear;
}
if (month==7)
{
nowtoday += jour+", "+"July"+" "+numday+" "+numyear;
}
if (month==8)
{
nowtoday += jour+", "+"August"+" "+numday+" "+numyear;
}
if (month==9)
{
nowtoday += jour+", "+"September"+" "+numday+" "+numyear;
}
if (month==10)
{
nowtoday += jour+", "+"October"+" "+numday+" "+numyear;
}
if (month==11)
{
nowtoday += jour+", "+"November"+" "+numday+" "+numyear;
}
if (month==12)
{
nowtoday += jour+" "+numday+" "+"D̩cembre"+" "+numyear;
}
nowtoday += " - ";
nowtoday += numhours+":"+numminutes;

// Creation date pour coffre
var datecoffre=numday+"/"+month+"/"+numyear +" at  " + numhours+":"+numminutes;
...
//fonction permettant de choisir le type g̩n̩ral de l'alerte (solde, operation, blocage carte)
...
//fonction qui remet les menus d̩roulant en position initiale
...
// fonction qui supprime une ligne du tableau r̩capitulatif
function supp(id)
{ 
...
//fonction qui ajoute dynamiquement une ligne au tableau r̩capitulatif si il y a un montant at  ecrire
...
//fonction qui ajoute dynamiquement une ligne au tableau r̩capitulatif si il n'y a pas de montant at  ecrire
...
i=0;
//fonction faisant clignoter un ̩l̩ment en passant la souris dessus
...
var texte_1=document.getElementById("textarea_1");
{
 texte_1.innerHTML=texte_1.innerHTML +  "<span class='conseiller'><b>Mr.Martin:</b> I keep being at your disposal for further information. Good bye.<BR></span>";
}
}
function reponse_conseiller()
{
 var texte_1=document.getElementById("textarea_1");
if((texte_1.innerHTML.indexOf("thank you")!=-1 || texte_1.innerHTML.indexOf("Thank you")!=-1 || texte_1.innerHTML.indexOf("THANK YOU")!=-1) && merci==0)
{
 merci=1;
 setTimeout("reponse()",3000); 
}
}
//-------------------------------fin messagerie instantan̩e--------------------------------
...
function afficheChoixAccount(maValeur){
	if (maValeur=="yes"){
		jQuery("#choixAccount").slideDown("def");		
	}
	else{
		jQuery("#choixAccount").slideUp("def");		
	}
}
