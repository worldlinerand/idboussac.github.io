...
public class SPDialogueFragment extends DialogFragment {
    ...
    public static SPDialogueFragment newInstance() {
        SPDialogueFragment spDialogueFragment = new SPDialogueFragment();
